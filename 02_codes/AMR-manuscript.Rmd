...
asia.ecoli.plot <- ggbarplot(asia.ecoli, "antimicrobial_compound", "Mean", 
  ...
  geom_text(data=tibble(x=2.5, y=111),
            aes(x=x, y=y, label="critically important"),
            inherit.aes=FALSE) +
  geom_text(data=tibble(x=6.5, y=111),
            aes(x=x, y=y, label="highly important"), 
            inherit.aes=FALSE)+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
...
N.A.ecoli.plot <- ggbarplot(N.A.ecoli, "antimicrobial_compound", "Mean", 
  ...
  geom_text(data=tibble(x=5, y=111),
            aes(x=x, y=y, label="critically important"),
            inherit.aes=FALSE) +
  geom_text(data=tibble(x=13, y=111),
            aes(x=x, y=y, label="highly important"), 
            inherit.aes=FALSE)+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
...
N.A.campylobacter.plot <- ggbarplot(N.A.campylobacter, "antimicrobial_compound", "Mean", 
  ...
  geom_text(data=tibble(x=5.3, y=100),
            aes(x=x, y=y, label="critically important"),
            inherit.aes=FALSE) +
  geom_text(data=tibble(x=14.1, y=100),
            aes(x=x, y=y, label="highly important"), 
            inherit.aes=FALSE)+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
...
europe.s.aureus.plot <- ggbarplot(europe.saureus, "antimicrobial_compound", 
  ...
  geom_text(data=tibble(x=5.3, y=110),
            aes(x=x, y=y, label="critically important"),
            inherit.aes=FALSE) +
  geom_text(data=tibble(x=19, y=110),
            aes(x=x, y=y, label="highly important"), 
            inherit.aes=FALSE)+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
...
``` {r drug acronyms,echo=FALSE, fig.height=15, fig.width=10, message=FALSE, rusults= "asis"}
...
data3 <- table(data2$antimicrobial, data2$antimicrobial_compound, data2$antimicrobial_class, data2$who_classification)



pandoc.table(data3, style="rmarkdown")
