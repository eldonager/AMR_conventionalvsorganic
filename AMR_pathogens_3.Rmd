...
conv.plot<- conv.plot+labs(x = "Host", fill = "Host")
##Changing x axis label order
...
europe.ecoli.plot <- ggbarplot(europe.ecoli, "antimicrobial_compound", "Mean", 
                               ...
                               legend.title = "Farm type",
                                font.subtitle = c(19))+
  annotate('rect', xmin=0, xmax=23.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
rotate_x_text(90)+
...
asia.ecoli.plot <- ggbarplot(asia.ecoli, "antimicrobial_compound", "Mean", 
                             ...
                             legend.title = "Farm type",
                             font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=5.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
N.A.ecoli.plot <- ggbarplot(N.A.ecoli, "antimicrobial_compound", "Mean", 
                            ...
                            legend.title = "Farm type",
                             font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=10.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
S.A.ecoli.plot <- ggbarplot(S.A.ecoli, "antimicrobial_compound", "Mean", 
                            ...
                            legend.title = "Farm type", 
                             font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=9.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
N.A.entero.plot <- ggbarplot(N.A.entero, "antimicrobial_compound", "Mean", 
                             ...
                             legend.title = "Farm type", 
                            font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=12.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
oceania.enterococcus.plot <- ggbarplot(oceania.entero, "antimicrobial_compound",
                                       ...
                                       legend.title = "Farm type",
                                       font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=3.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
asia.salmonella.plot <- ggbarplot(asia.sal, "antimicrobial_compound",
                                  ...
                                  legend.title = "Farm type",
                                 font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=14.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
N.A.Staphylococcus.plot <- ggbarplot(N.A.staphy, "antimicrobial_compound", "Mean", 
                                     ...
                                     legend.title = "Farm type", 
                                    font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=1.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
...
N.A.saureus.plot <- ggbarplot(N.A.saureus, "antimicrobial_compound",
                             ...
                             legend.title = "Farm type", 
                             font.subtitle = c(19))+
   annotate('rect', xmin=0, xmax=6.5, ymin=0, ymax=100, alpha=.5, fill='gray')+
  rotate_x_text(90)+
  geom_linerange(aes(group = farm_type, ymax = CIHigh, ymin = CILow),
                 position = position_dodge(width = 0.7))+
  font("xy.text", size = 19)+
